...
abstract class ParentSnacks extends StatefulWidget {
  ParentSnacks({
    super.key,
    required this.child,
  ...
  @override
  State<ParentSnacks> createState() => _ParentSnacksState();
}

class _ParentSnacksState extends State<ParentSnacks> {
  double? top = -150;
  double? bottom = -150;
